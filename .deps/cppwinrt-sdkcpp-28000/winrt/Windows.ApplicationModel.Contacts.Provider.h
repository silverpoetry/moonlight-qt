...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::ApplicationModel::Contacts::Contact>) consume_Windows_ApplicationModel_Contacts_Provider_IContactProvider<D>::GetContactFromRemoteIdAsync(param::hstring const& contactRemoteId) const
    {
        void* operation{};
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_ApplicationModel_Contacts_Provider_IContactProvider<D>::ContactListId() const
    {
        void* value{};

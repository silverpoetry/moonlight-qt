...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::UriActionEntity) CreateUriEntity(winrt::Windows::Foundation::Uri const& Uri) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ArrayActionEntity) CreateArrayEntity(winrt::Windows::AI::Actions::ActionEntityKind const& kind, array_view<winrt::Windows::AI::Actions::ActionEntity const> entities) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::DateTimeActionEntity) CreateDateTimeEntity(winrt::Windows::Foundation::DateTime const& dateTime) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::AppointmentActionEntity) CreateAppointmentEntity(param::hstring const& sourceId, winrt::Windows::ApplicationModel::Appointments::Appointment const& appointment, array_view<winrt::Windows::AI::Actions::ContactActionEntity const> attendees) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::CustomTextActionEntity) CreateCustomTextEntity(param::hstring const& kind, param::hstring const& keyPhrase, param::map_view<hstring, winrt::Windows::Foundation::IInspectable> const& props) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ArrayActionEntity) CreateArrayEntityWithCustomKind(winrt::Windows::AI::Actions::ActionEntityKind const& elementKind, param::hstring const& customKind, array_view<winrt::Windows::AI::Actions::ActionEntity const> entities) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::AI::Actions::ActionInvocationHelpDetails, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Changed_revoker Changed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::AI::Actions::ActionInvocationHelpDetails, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationContext) GetActionInvocationContextFromToken(param::hstring const& token) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::CustomActionEntityStore) CustomEntityStore() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionRuntime) GetDefault() const;
    };
    ...
    struct consume_Windows_AI_Actions_IAppointmentActionEntity
    {
        ...
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::ContactActionEntity>) GetAttendees() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::RemoteFileActionEntity>) GetPresentedFiles() const;
        WINRT_IMPL_AUTO(void) SetPresentedFiles(array_view<winrt::Windows::AI::Actions::RemoteFileActionEntity const> files) const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::RemoteFileActionEntity>) GetSharedFiles() const;
        WINRT_IMPL_AUTO(void) SetSharedFiles(array_view<winrt::Windows::AI::Actions::RemoteFileActionEntity const> files) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityKind) ElementKind() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::ActionEntity>) GetAll() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) CustomElementKind() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::DateTime) GetLastModifiedTime(param::hstring const& kind) const;
        WINRT_IMPL_AUTO(void) Insert(winrt::Windows::AI::Actions::CustomTextActionEntity const& entity) const;
        WINRT_IMPL_AUTO(void) InsertMany(array_view<winrt::Windows::AI::Actions::CustomTextActionEntity const> entities) const;
        WINRT_IMPL_AUTO(void) Delete(param::hstring const& kind) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) CustomTextKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) KeyPhrase() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::DateTime) DateTime() const;
    };
    ...
    struct consume_Windows_AI_Actions_IRemoteFileActionEntity2
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ContactActionEntity) Creator() const;
        WINRT_IMPL_AUTO(void) Creator(winrt::Windows::AI::Actions::ContactActionEntity const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::DateTime>) LastUpdatedTime() const;
        WINRT_IMPL_AUTO(void) LastUpdatedTime(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::DateTime> const& value) const;
        WINRT_IMPL_AUTO(void) SetContributors(array_view<winrt::Windows::AI::Actions::ContactActionEntity const> contributors) const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::ContactActionEntity>) GetContributors() const;
    };

...
WINRT_EXPORT namespace winrt::Windows::Media::ClosedCaptioning
{
    ...
    struct __declspec(empty_bases) ClosedCaptionTheme : winrt::Windows::Media::ClosedCaptioning::IClosedCaptionTheme
    {
        ...
        [[nodiscard]] static ThemesChanged_revoker ThemesChanged(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler);
        ...
        [[nodiscard]] static SelectedThemeChanged_revoker SelectedThemeChanged(auto_revoke_t, winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler);

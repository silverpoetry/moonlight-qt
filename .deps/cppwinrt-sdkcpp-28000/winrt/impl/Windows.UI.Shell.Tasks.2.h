...
{
    struct __declspec(empty_bases) AppTaskContent : winrt::Windows::UI::Shell::Tasks::IAppTaskContent
    {
    ...
    struct __declspec(empty_bases) AppTaskInfo : winrt::Windows::UI::Shell::Tasks::IAppTaskInfo,
    ...
    struct __declspec(empty_bases) AppTaskResultAsset : winrt::Windows::UI::Shell::Tasks::IAppTaskResultAsset
    {

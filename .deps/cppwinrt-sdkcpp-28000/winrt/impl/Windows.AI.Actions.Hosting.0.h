...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionInstance>) GetActionsForInputs(array_view<winrt::Windows::AI::Actions::ActionEntity const> inputEntities) const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionInstance>) GetActionsForInputs(array_view<winrt::Windows::AI::Actions::ActionEntity const> inputEntities, winrt::Windows::UI::WindowId const& invokerWindowId) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionDefinition>) GetActionsForCurrentApp() const;
    };
    ...
    struct consume_Windows_AI_Actions_Hosting_IActionDefinition2
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) UsesGenerativeAI() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsCurrentlyAvailable() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetIconFullPath(winrt::Windows::Foundation::Collections::PropertySet const& qualifierValues) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::Hosting::ActionInstanceDisplayInfo) DisplayInfo() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::Hosting::ActionDefinition) Definition() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationContext) Context() const;

...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) EnvironmentInfo() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::AcquireEnvironmentInfoResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, param::hstring const& environmentInfo) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsRebootPending() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::AreRebootsPendingResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateOperationResult const& result, bool isRebootPending) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::AcquireEnvironmentInfoResult) AcquireNodeEnvironmentInfo() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ValidateClusterEnvironmentResult) ValidateClusterEnvironment(param::map_view<hstring, hstring> const& nodeEnvironmentInfo) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPreUpdateRunOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPreUpdateRunOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPostUpdateRunOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPostUpdateRunOperationComplete() const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IClusterNativeEnvironmentOperationsPlugin
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePluginVersionInfo) Version() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) DefaultOptions() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::IClusterNativeEnvironmentOperations) CreateEnvironmentOperations(param::hstring const& clusterName, param::hstring const& runId, param::map<hstring, hstring> const& options, winrt::Windows::Management::Update::Cluster::ClusterUpdateServices const& updateServices) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::AreRebootsPendingResult) AreAdditionalRebootsPending() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPreRebootOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPreRebootOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPostRebootOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPostRebootOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPreDrainOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPreDrainOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPostResumeOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPostResumeOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPreUpdateRunOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPreUpdateRunOperationComplete() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) StartPostUpdateRunOperation() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) IsPostUpdateRunOperationComplete() const;
    ...
    struct consume_Windows_Management_Update_Cluster_IClusterNativeNodeOperationsPlugin
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePluginVersionInfo) Version() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) DefaultOptions() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::IClusterNativeNodeOperations) CreateNodeOperations(param::hstring const& clusterName, param::hstring const& runId, param::map<hstring, hstring> const& options, winrt::Windows::Management::Update::Cluster::ClusterUpdateServices const& updateServices) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) WriteLogEntry(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateLogLevel const& level, param::hstring const& message) const;
        WINRT_IMPL_AUTO(void) ReportProgress(int32_t currentStep, int32_t maxSteps, param::hstring const& message) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateCredential) GetPluginCredential(param::hstring const& credentialId) const;
        WINRT_IMPL_AUTO(bool) IsOperationMarkedAsCanceled() const;
        WINRT_IMPL_AUTO(void) SaveRunStateInformation(param::hstring const& persistentInformation) const;
        WINRT_IMPL_AUTO(hstring) GetRunStateInformation() const;
        WINRT_IMPL_AUTO(void) SaveRunIndependentInformation(param::hstring const& persistentInformation) const;
        WINRT_IMPL_AUTO(hstring) GetRunIndependentInformation() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateInstallRecord>) InstallRecords() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) ShouldRollback() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::InstallUpdateTaskResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateInstallRecord> const& installRecords, bool shouldRollback) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::RollbackUpdateTaskResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateInstallRecord> const& installRecords) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateScanRecord>) ScanRecords() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ScanUpdateTaskResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateScanRecord> const& scanRecords) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateStageRecord>) StageRecords() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::StageUpdateTaskResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateStageRecord> const& stageRecords) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCredentialStatus) Status() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateCredential) CreateInstance(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCredentialStatus const& status, param::hstring const& userName, param::hstring const& password) const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IUpdateInstallRecord
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsRebootRequired() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCompletionStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FailureMessage() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateInstallRecord) CreateInstance(param::hstring const& updateId, bool isRebootRequired, winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCompletionStatus const& status, param::hstring const& failureMessage) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ScanUpdateTaskResult) Scan() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::StageUpdateTaskResult) Stage(param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateScanRecord> const& updatesToStage) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::InstallUpdateTaskResult) Install(param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateScanRecord> const& updatesToInstall) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::RollbackUpdateTaskResult) Rollback(param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateScanRecord> const& updatesToRollback) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) ShouldUsePluginSpecificReboot(bool& usePluginReboot) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) RebootNode() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) AcquireUpdateListValidationInfo(hstring& recipeValidationInfo) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ValidateAllNodesUpdateRecipeResult) ValidateAllNodesUpdateRecipe(param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateRecipeNodeValidationInfoRecord> const& allNodesRecipeValidationInfo) const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IUpdateInstallerPlugin
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Description() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePluginVersionInfo) Version() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsUpdateRollbackSupported() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMapView<hstring, hstring>) DefaultOptions() const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::IUpdateInstaller) CreateUpdateInstaller(param::hstring const& clusterName, param::hstring const& runId, param::map<hstring, hstring> const& options, winrt::Windows::Management::Update::Cluster::ClusterUpdateServices const& updateServices) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateOperationStatus) StatusCode() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) CreateInstance(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateOperationStatus const& status, param::hstring const& reason) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) CreateInstance2(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateOperationStatus const& status, param::hstring const& reason, int32_t errorCode) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateOperationResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) SuggestedRecheckInterval() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePendingOperationResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateOperationResult const& result, winrt::Windows::Foundation::TimeSpan const& suggestedRecheckInterval) const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IUpdatePluginVersionInfo
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) PatchLevel() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdatePluginVersionInfo) CreateInstance(uint32_t majorVersion, uint32_t minorVersion, uint32_t patchLevel) const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IUpdateRecipeNodeValidationInfoRecord
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) RecipeValidationInfo() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateScanRecord>) ScanResults() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateRecipeNodeValidationInfoRecord) CreateInstance(param::hstring const& nodeName, param::hstring const& recipeValidationInfo, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateScanRecord> const& scanResults) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UpdateId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UpdateTitle() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UpdateDescription() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsRebootRequired() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PluginSpecificData() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateScanRecord) CreateInstance(param::hstring const& updateId, param::hstring const& updateTitle, param::hstring const& updateDescription, bool isRebootRequired, param::hstring const& pluginSpecificData) const;
    };
    ...
    struct consume_Windows_Management_Update_Cluster_IUpdateStageRecord
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCompletionStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FailureMessage() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UpdatedPluginSpecificData() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateStageRecord) CreateInstance(param::hstring const& updateId, winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCompletionStatus const& status, param::hstring const& failureMessage) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateStageRecord) CreateInstance2(param::hstring const& updateId, winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateCompletionStatus const& status, param::hstring const& failureMessage, param::hstring const& updatedPluginSpecificData) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) CreateInstance(bool succeeded, param::hstring const& reason) const;
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) CreateInstance2(bool succeeded, param::hstring const& reason, int32_t errorCode) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateLogLevel) Severity() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateValidationLogMessage) CreateInstance(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateLogLevel const& severity, param::hstring const& message) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) AreUpdatesApproved() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateValidationLogMessage>) ValidationMessages() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ValidateAllNodesUpdateRecipeResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, bool areUpdatesApproved, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateValidationLogMessage> const& validationMessages) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::UpdateTaskResult) Result() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateEnvironmentValidationStatus) ApprovalStatus() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Management::Update::Cluster::UpdateValidationLogMessage>) ValidationMessages() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Update::Cluster::ValidateClusterEnvironmentResult) CreateInstance(winrt::Windows::Management::Update::Cluster::UpdateTaskResult const& result, winrt::Windows::Management::Update::Cluster::ClusterNativeUpdateEnvironmentValidationStatus const& approvalStatus, param::vector_view<winrt::Windows::Management::Update::Cluster::UpdateValidationLogMessage> const& validationMessages) const;
    };

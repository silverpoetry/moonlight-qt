...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextConversionMode) NewConversionMode() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxInfo) FocusedTextBoxInfo() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) DelegationOn() const;
    };
    ...
    struct consume_Windows_UI_Input_Preview_Text_IKeyEventReceivedEventArgs
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Unicode() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::KeyEventDeviceType) Source() const;
        WINRT_IMPL_AUTO(bool) IsKeyPressed(winrt::Windows::System::VirtualKey const& vkey) const;
        WINRT_IMPL_AUTO(bool) IsToggleKeyOn(winrt::Windows::System::VirtualKey const& vkey) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextEditSession) EditSession() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) InputProfile() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsActive() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasFocusedTextBox() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxId) FocusedTextBoxId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxInfo) FocusedTextBoxInfo() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect>) FocusedTextBoxBounds() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect>) SelectionBounds() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextConversionMode) ConversionMode() const;
        WINRT_IMPL_AUTO(void) ConversionMode(winrt::Windows::UI::Input::Preview::Text::TextConversionMode const& value) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextEditSession) CreateEditSession() const;
        WINRT_IMPL_AUTO(winrt::event_token) Activated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Activated_revoker Activated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) Activated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) Deactivated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Deactivated_revoker Deactivated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) Deactivated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) KeyEventReceived(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::KeyEventReceivedEventArgs> const& handler) const;
        ...
        [[nodiscard]] KeyEventReceived_revoker KeyEventReceived(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::KeyEventReceivedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) KeyEventReceived(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) FocusEntered(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::FocusEnteredEventArgs> const& handler) const;
        ...
        [[nodiscard]] FocusEntered_revoker FocusEntered(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::FocusEnteredEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) FocusEntered(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) FocusRemoved(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] FocusRemoved_revoker FocusRemoved(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) FocusRemoved(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) ConversionModeChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::ConversionModeChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] ConversionModeChanged_revoker ConversionModeChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::ConversionModeChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ConversionModeChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) TextBoxInfoChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::TextBoxInfoChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] TextBoxInfoChanged_revoker TextBoxInfoChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::TextBoxInfoChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) TextBoxInfoChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) TextBoxContentChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::TextBoxContentChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] TextBoxContentChanged_revoker TextBoxContentChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::TextBoxContentChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) TextBoxContentChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) CompositionTerminated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] CompositionTerminated_revoker CompositionTerminated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) CompositionTerminated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) ReconversionRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::ReconversionRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] ReconversionRequested_revoker ReconversionRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor, winrt::Windows::UI::Input::Preview::Text::ReconversionRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ReconversionRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxId) TextBoxId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextChangeSource) Source() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Rect) SelectionBounds() const;
        WINRT_IMPL_AUTO(bool) IsContentAttributeChanged(winrt::Windows::UI::Input::Preview::Text::TextBoxContentAttribute const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxId) Id() const;
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxSettings) Settings() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxFeatures) DisabledFeatures() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxInfo) TextBoxInfo() const;
    };
    ...
    struct consume_Windows_UI_Input_Preview_Text_ITextComposition
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextCompositionSegment) FirstSegment() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextCompositionSegment) SelectedSegment() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) CaretPosition() const;
        WINRT_IMPL_AUTO(void) CaretPosition(uint32_t value) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextCompositionSegment) InsertText(param::hstring const& text) const;
        WINRT_IMPL_AUTO(void) Complete() const;
        WINRT_IMPL_AUTO(void) CompleteUnconverted() const;
        WINRT_IMPL_AUTO(void) CompleteFirstSegment() const;
    };
    ...
    struct consume_Windows_UI_Input_Preview_Text_ITextCompositionSegment
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ConvertedText() const;
        WINRT_IMPL_AUTO(void) ConvertedText(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UnconvertedText() const;
        WINRT_IMPL_AUTO(void) UnconvertedText(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::Core::CoreTextRange) Range() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::Core::CoreTextFormatUpdatingReason) ConversionState() const;
        WINRT_IMPL_AUTO(void) ConversionState(winrt::Windows::UI::Text::Core::CoreTextFormatUpdatingReason const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextCompositionSegment) Next() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextCompositionSegment) Previous() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextStyle) GetTextStyle() const;
        WINRT_IMPL_AUTO(void) SetTextStyle(winrt::Windows::UI::Input::Preview::Text::TextStyle const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxId) TextBoxId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) TextLength() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Text::Core::CoreTextRange) PopulatedRange() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) PopulateAsync(winrt::Windows::UI::Text::Core::CoreTextRange const& range) const;
        WINRT_IMPL_AUTO(hstring) GetText(winrt::Windows::UI::Text::Core::CoreTextRange const& range) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Text::Core::CoreTextRange) GetSelectedRange() const;
        WINRT_IMPL_AUTO(void) SetSelectedRange(winrt::Windows::UI::Text::Core::CoreTextRange const& value) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Text::Core::CoreTextRange) ReplaceText(winrt::Windows::UI::Text::Core::CoreTextRange const& replaceRange, param::hstring const& text) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextComposition) Composition() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextComposition) StartComposition() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextComposition) StartReconversion(winrt::Windows::UI::Text::Core::CoreTextRange const& range) const;
        WINRT_IMPL_AUTO(bool) SubmitPayload() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::UI::Input::Preview::Text::PayloadResult>) SubmitPayloadAsync() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextInputServiceSubscription) GetSubscription() const;
        WINRT_IMPL_AUTO(void) SetSubscription(winrt::Windows::UI::Input::Preview::Text::TextInputServiceSubscription const& subscription) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HasFocusedTextBox() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxId) FocusedTextBoxId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextBoxInfo) FocusedTextBoxInfo() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect>) FocusedTextBoxBounds() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Foundation::Rect>) SelectionBounds() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextEditSession) CreateEditSession() const;
        WINRT_IMPL_AUTO(bool) TryStartDelegation() const;
        WINRT_IMPL_AUTO(void) StopDelegation() const;
        WINRT_IMPL_AUTO(winrt::event_token) FocusEntered(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::FocusEnteredEventArgs> const& handler) const;
        ...
        [[nodiscard]] FocusEntered_revoker FocusEntered(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::FocusEnteredEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) FocusEntered(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) FocusRemoved(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] FocusRemoved_revoker FocusRemoved(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) FocusRemoved(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) TextBoxInfoChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::TextBoxInfoChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] TextBoxInfoChanged_revoker TextBoxInfoChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::TextBoxInfoChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) TextBoxInfoChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) TextBoxContentChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::TextBoxContentChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] TextBoxContentChanged_revoker TextBoxContentChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::TextBoxContentChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) TextBoxContentChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) CompositionTerminated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] CompositionTerminated_revoker CompositionTerminated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) CompositionTerminated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) ReconversionRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::ReconversionRequestedEventArgs> const& handler) const;
        ...
        [[nodiscard]] ReconversionRequested_revoker ReconversionRequested(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::ReconversionRequestedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) ReconversionRequested(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) InputDelegationModeChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::InputDelegationModeChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] InputDelegationModeChanged_revoker InputDelegationModeChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::Preview::Text::TextInputProvider, winrt::Windows::UI::Input::Preview::Text::InputDelegationModeChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) InputDelegationModeChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::KeyboardInputProcessor) CreateKeyboardInputProcessor(param::hstring const& inputProfile) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextInputProvider) CreateTextInputProvider(param::hstring const& inputProfile) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Input::Preview::Text::TextInputService) GetForCurrentThread() const;
    };

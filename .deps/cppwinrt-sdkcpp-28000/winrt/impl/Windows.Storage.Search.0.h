...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IncludeLocalSemanticIndex() const;
        WINRT_IMPL_AUTO(void) IncludeLocalSemanticIndex(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IncludeCloudProviders() const;
        WINRT_IMPL_AUTO(void) IncludeCloudProviders(bool value) const;
    };

...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) AddButton(param::hstring const& text, winrt::Windows::Foundation::Uri const& actionUri) const;
        WINRT_IMPL_AUTO(void) SetTextInput(param::hstring const& placeholderText, param::hstring const& actionUriTemplate) const;
        WINRT_IMPL_AUTO(void) SetQuestion(param::hstring const& question) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskContent) CreateSequenceOfSteps(array_view<hstring const> completedSteps, param::hstring const& executingStep) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskContent) CreatePreviewThumbnail(winrt::Windows::Foundation::Uri const& imageUri, param::hstring const& executingStep) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskContent) CreateTextSummaryResult(param::hstring const& text) const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskContent) CreateGeneratedAssetsResult(array_view<winrt::Windows::UI::Shell::Tasks::AppTaskResultAsset const> assets) const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) MaxButtons() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) Remove() const;
        WINRT_IMPL_AUTO(void) Update(winrt::Windows::UI::Shell::Tasks::AppTaskState const& state, winrt::Windows::UI::Shell::Tasks::AppTaskContent const& content) const;
        WINRT_IMPL_AUTO(void) UpdateState(winrt::Windows::UI::Shell::Tasks::AppTaskState const& state) const;
        WINRT_IMPL_AUTO(void) UpdateTitles(param::hstring const& title, param::hstring const& subtitle) const;
        WINRT_IMPL_AUTO(com_array<hstring>) GetCompletedSteps() const;
        WINRT_IMPL_AUTO(hstring) GetExecutingStep() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Title() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Subtitle() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri) DeepLink() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri) IconUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskState) State() const;
    ...
    struct consume_Windows_UI_Shell_Tasks_IAppTaskInfo2
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(bool) HiddenByUser() const;
        WINRT_IMPL_AUTO(void) UpdateDeepLink(winrt::Windows::Foundation::Uri const& deepLink) const;
    };
    ...
    struct consume_Windows_UI_Shell_Tasks_IAppTaskInfoStatics
    {
        ...
        WINRT_IMPL_AUTO(com_array<winrt::Windows::UI::Shell::Tasks::AppTaskInfo>) FindAll() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskInfo) Create(param::hstring const& title, param::hstring const& subtitle, winrt::Windows::Foundation::Uri const& deepLink, winrt::Windows::Foundation::Uri const& iconUri, winrt::Windows::UI::Shell::Tasks::AppTaskContent const& content) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::Shell::Tasks::AppTaskResultAsset) CreateInstance(param::hstring const& name, param::hstring const& context, winrt::Windows::Foundation::Uri const& iconUri, winrt::Windows::Foundation::Uri const& assetUri) const;
    };

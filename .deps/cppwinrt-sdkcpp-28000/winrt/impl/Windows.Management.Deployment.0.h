...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Deployment::PackageOperationPriority) PackageOperationPriority() const;
        WINRT_IMPL_AUTO(void) PackageOperationPriority(winrt::Windows::Management::Deployment::PackageOperationPriority const& value) const;
    };

...
namespace winrt::impl
{
    ...
    struct consume_Windows_ApplicationModel_Preview_IStartupAppInfoPreview
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::Preview::StartupAppImpactPreview) Impact() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ExecutablePath() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::ApplicationModel::Preview::StartupAppInfoPreview>) GetStartupAppInfos() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::Preview::StartupAppsManagerPreview) GetDefault() const;
    };

...
{
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<winrt::Windows::Devices::Printers::IppAttributeGroupKind, winrt::Windows::Foundation::Collections::IMap<hstring, winrt::Windows::Devices::Printers::IppAttributeValue>>) consume_Windows_Devices_Printers_IIppAttributeConverterStatics<D>::ConvertPrintTicketToIppAttributesForPrinter(param::hstring const& printerName, winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& printTicket) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppAttributeConverterStatics)->ConvertPrintTicketToIppAttributesForPrinter(*(void**)(&printerName), *(void**)(&printTicket), &result));
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<hstring, winrt::Windows::Devices::Printers::IppAttributeValue>) consume_Windows_Devices_Printers_IIppAttributeConverterStatics<D>::ConvertBufferToIppAttributes(winrt::Windows::Storage::Streams::IBuffer const& attributesBuffer) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Storage::Streams::IBuffer) consume_Windows_Devices_Printers_IIppAttributeConverterStatics<D>::ConvertIppAttributesToBuffer(param::iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, winrt::Windows::Devices::Printers::IppAttributeValue>> const& attributes, winrt::Windows::Devices::Printers::IppAttributeGroupKind const& attributeGroupKind) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IPdlPassthroughProvider2<D>::IsPassthroughWithJobAttributesSupported() const
    {
        bool value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::PdlPassthroughTarget) consume_Windows_Devices_Printers_IPdlPassthroughProvider2<D>::StartPrintJobWithIppJobAttributes(param::hstring const& jobName, param::hstring const& pdlContentType, winrt::Windows::Storage::Streams::IBuffer const& jobAttributes, winrt::Windows::Storage::Streams::IBuffer const& operationAttributes) const
    {
        void* result{};
